...
| DS-0402 | [Migrate shell and global interaction surfaces](02-shell-global-ui.md)                   | DS-0401                 | Complete |
| DS-0403 | [Migrate specialist management flows](03-specialists.md)                                 | DS-0401                 | Complete |
| DS-0404 | [Migrate task authoring and template flows](04-task-authoring.md)                        | DS-0401                 | Complete |
| DS-0405 | [Migrate task board, detail, and run flows](05-task-operations.md)                       | DS-0401, DS-0404        | Complete |
| DS-0406 | [Migrate integrations and provider flows](06-integrations-providers.md)                  | DS-0401                 | Complete |
| DS-0407 | [Migrate settings, API, and custom-tool flows](07-settings-api-tools.md)                 | DS-0401                 | Complete |
| DS-0408 | [Migrate chat and media chrome](08-chat-media.md)                                        | DS-0401                 | Complete |
| DS-0409 | [Migrate workspace, Documents, and file-manager chrome](09-workspace-documents-files.md) | DS-0401                 | Complete |
| DS-0410 | [Close palette, icon, component, and compatibility inventories](10-inventory-ratchet.md) | DS-0402 through DS-0409 | Complete |
| DS-0411 | [Add integrated domain migration baselines](11-domain-baselines.md)                      | DS-0402 through DS-0410 | Complete |
| DS-0412 | [Verify and sign off Phase 4](12-phase-4-signoff.md)                                     | DS-0402 through DS-0411 | Complete |
