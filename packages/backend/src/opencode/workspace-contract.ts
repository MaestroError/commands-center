...
export function renderOpenCodeWorkspace(input: OpenCodeWorkspaceInput): {
  ...
  return {
    rulesMarkdown: [
      ...
      "",
      "This directory is your own specialist workspace. Do not change another specialist's workspace unless the user explicitly asks for the exact location and change.",
      "",
      "## Instructions",
      "",
      rules.instructions,
